...
/**
 * type of mathOperations used in Calculator instance
 */
type mathOperations= {
  sin: () => void;
  cos: () => void;
...
/**
 * type of modeManager used in Calculator instance
 */
type modeManager={
    changeMode: () => void;
}
...
class InputHandler {
  ...
  private initEventListeners(): void {
    ...
    document.addEventListener(
      'keydown',
      this.backspaceHandler as EventListener,
    );
    ...
    if (trignoDropdown) {
      trignoDropdown.addEventListener(
        'click',
   ...
   * @private
   */
  private backspaceHandler(e: KeyboardEvent){
